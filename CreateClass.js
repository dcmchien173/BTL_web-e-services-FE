...
function addQue() {
    ...
    var html = '';
    i++;
    html += '<div class="create_new_ID row" name="ID" id="createID"  style="width: 100%;">';
    html += '<div class="col-sm-3"></div>';
    html += `<div class="col-sm-6 question" id="${i}">`;
    html += '<<div class="remove-ID-div">';
    html += '<button id="removeRow" type="button" class="" style="float: right; margin-top:20px; margin-right: 20px;">';
    html += '<i class="fas fa-trash-alt"></i>';
    html += '</button>';
    html += '</div>';
    html += '<<div class="Student-infor row" >';
    html += '<div id="Student-information">';
    html += '<div class="col-sm-11 student-div" id="student">';
    html += `<textarea class="student-description" rows="2" id="stu-des1${i}" placeholder="Student-name"></textarea>`;
    html += '</div>';
    html += '</div>';
    html += '</div>';
    html += '<div class="add-more-option-div col-sm-3">';
    html += `<button class="add-more-option btn-primary" onclick="addInnerQue('createOption${i}')" type="button">Add Student</button>`;
    html += '</div>';
    ...
    html += '<div class="add_new_quiz row" name="quiz" id="addquiz"  style="width: 100%;">';
    html += '<div class="col-sm-3"></div>';
    html += `<div class="col-sm-6 question" id="${i}">`;
    ...
    html += `<textarea class="question-description" rows="2" id="ques-des${i}" placeholder="Quiz"></textarea>`;
    html += '</div>';
    ...
    html += '</div>';
    html += '<div class="add-more-option-div col-sm-3">';
    html += `<button class="add-more-option btn-primary" onclick="addInnerQue('createOption${i}')" type="button">Add quiz</button>`;
    html += '</div>';
    html += '<div class="col-sm-10"></div>';
    html += '</div>';
    html += '<br>';
